        ...
        tables: [
          {
            ...
            required: true,
            columns: [
              { name: "criteria", required: true, label: "", align: "left" },
              {
                name: "Needs Improvement",
                align: "center",
                label: "Needs Improvement",
              },
              { name: "Satisfactory", align: "center", label: "Satisfactory" },
              { name: "Strong", align: "center", label: "Strong" },
              {
                name: "Outstanding - Top 5%",
                align: "center",
                label: "Outstanding - Top 5%",
              },
              { name: "Not Observed", align: "center", label: "Not Observed" },
            ],
            rows: [
              { id: 1, criteria: "Spoken English", required: true, value: "" },
              {
                id: 2,
                criteria: "Written English (including emails)",
                required: true,
          ...
          // Repeat for other tables (  interaction-student, overall-assessment)
          {
            name: "professional-attitudes",
            label: "Professional Attitudes & Behavior",
            description:
